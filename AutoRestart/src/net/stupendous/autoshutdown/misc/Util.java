...
public class Util
{
  ...
  public static void broadcast(String format, Object[] args)
  {
    ...
    Bukkit.getConsoleSender().sendMessage("¡ìa1111111111111");
    /*
    ...
    */
    formattedMessage = parseColor("&2[&a%s&2] &f%s", new Object[] { "×Ô¶¯ÖØÆô", msg });
    Bukkit.getConsoleSender().sendMessage("¡ìa222222222");
    plugin.getServer().broadcastMessage(formattedMessage);
    Bukkit.getConsoleSender().sendMessage("¡ìa333333333");
  }
}